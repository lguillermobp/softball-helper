  ...
  en: {
    ...
    register: {
      ...
      steps: {
        ...
        league:     { title: "Set up your league",        subtitle: "Choose a name and plan for your league", name: "League name", namePlaceholder: "Riverside Softball League", city: "City", cityPlaceholder: "Springfield", state: "State", statePlaceholder: "IL", sport: "Sport", softball: "Softball", baseball: "Baseball", kickball: "Kickball", selectPlan: "Select a plan", back: "Back", continue: "Continue" },
    ...
    league: {
      ...
      overview: {
        ...
        sport: "Sport", softball: "Softball", baseball: "Baseball", kickball: "Kickball", saving: "Saving…",
      },
  ...
  es: {
    ...
    register: {
      ...
      steps: {
        ...
        league:     { title: "Configura tu liga",           subtitle: "Elige un nombre y plan para tu liga", name: "Nombre de la liga", namePlaceholder: "Liga de Sóftbol Riverside", city: "Ciudad", cityPlaceholder: "Caracas", state: "Estado", statePlaceholder: "Miranda", sport: "Deporte", softball: "Sóftbol", baseball: "Béisbol", kickball: "Kickball", selectPlan: "Selecciona un plan", back: "Atrás", continue: "Continuar" },
    ...
    league: {
      ...
      overview: {
        ...
        sport: "Deporte", softball: "Sóftbol", baseball: "Béisbol", kickball: "Kickball", saving: "Guardando…",
      },
  ...
  ja: {
    ...
    register: {
      ...
      steps: {
        ...
        league:     { title: "リーグを設定",        subtitle: "リーグの名前とプランを選択してください", name: "リーグ名", namePlaceholder: "〇〇ソフトボールリーグ", city: "市区町村", cityPlaceholder: "東京", state: "都道府県", statePlaceholder: "東京都", sport: "スポーツ", softball: "ソフトボール", baseball: "野球", kickball: "キックボール", selectPlan: "プランを選択", back: "戻る", continue: "続ける" },
    ...
    league: {
      ...
      overview: {
        ...
        sport: "スポーツ", softball: "ソフトボール", baseball: "野球", kickball: "キックボール", saving: "保存中…",
      },
